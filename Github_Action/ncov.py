...
response = requests.request('get', f'https://api.day.app/xZnrY2aM3xJJK6JsBNfPv3/success!/UPC-疫情防控通已上报({curr_time.month}月{curr_time.day}日{curr_time.hour}:{str})?group=疫情防控通签到')
print(response)
